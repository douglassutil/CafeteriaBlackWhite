 ...
 * @author Michelle
 */
public class FabricaCafeDescafeinadoTest {
    
    public FabricaCafeDescafeinadoTest() {
    }
    ...
    /**
     * Test of addIngrediente method, of class FabricaCafeDescafeinado.
     */
    @Test
    public void testAddIngrediente() {
        System.out.println("addIngrediente");
        FabricaCafeDescafeinado instance = new FabricaCafeDescafeinado();
    ...
    /**
     * Test of criarCafe method, of class FabricaCafeDescafeinado.
     */
    @Test
