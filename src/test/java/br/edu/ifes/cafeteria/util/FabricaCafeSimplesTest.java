 ...
 * @author Michelle
 */
public class FabricaCafeSimplesTest {
    
    public FabricaCafeSimplesTest() {
    }
    ...
    /**
     * Test of addIngrediente method, of class FabricaCafeSimples.
     */
    @Test
    public void testAddIngrediente() {
        System.out.println("addIngrediente");
        FabricaCafeSimples instance = new FabricaCafeSimples();
    ...
    /**
     * Test of criarCafe method, of class FabricaCafeSimples.
     */
    @Test
